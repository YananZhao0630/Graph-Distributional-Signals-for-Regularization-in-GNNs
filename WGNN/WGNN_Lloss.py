...
def main(args, g_new=None, run=0, new_labels=None, new_train_mask=None):
    ...
    for epoch in range(args.n_epochs):
        ...
        if new_train_mask is None:
            ...
            loss = loss1+ eta_star*LEReg_loss(g,logits, m,a,b)
        else:
    ...
    print("Test accuracy {:.2%}".format(acc), 'eta_regu', eta_star)
...
if __name__ == '__main__':
    ...
    parser.add_argument("--eta_star", type= float, default =0)
    ...
    for eta3 in range(0,101,10):
        test_acc_list = []
        for run in range(10):
            if args.dataset in ['wisconsin', 'texas', 'cornell','chameleon']:
    ...
    print('best eta3: ', max_key_wgnn, ', score: ', wgnn_result_acc[max_key_wgnn]*100, wgnn_result_std[max_key_wgnn]*100, 'eta:', args.eta_star, 'm:', args.m, 'a:', args.a, 'b:', args.b)
